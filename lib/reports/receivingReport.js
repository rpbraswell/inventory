...
function receivingReport( days, filterClass, resultHandler ) {
...
function receivingReportCSV( days, filterClass, file, resultHandler) {
 ...
 */
function receivingReportDetails( days = 30, sortField = "name", filterClass, resultHandler ) {
    let filter = filterClass == "all" ? '' : `and i.itemClass = '${filterClass}'`;
