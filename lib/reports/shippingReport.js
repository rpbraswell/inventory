...
function shippingReport( days = 30, filterClass, resultHandler ) {
...
function shippingReportCSV( days, filterClass, file, resultHandler) {
 ...
 */
function shippingReportDetails( days, sortField = "name", filterClass, resultHandler ) {
    let filter = filterClass == "all" ? '' : `and i.itemClass = '${filterClass}'`;
