...
const fs = require('fs')
    ...
    */
function transferReport( days = 30, resultHandler ) {
 ...
 *  throws an error if the query failes to calls to this function should be wrapped in a try/catch block
 */
function transferReportDetails( days = 30, sortField = "name", resultHandler ) {
...
function transferReportCSV( days = 30, file, resultHandler ) {
